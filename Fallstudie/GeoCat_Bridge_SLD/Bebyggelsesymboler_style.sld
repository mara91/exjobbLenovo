  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>Gästhamn</Name>
          <Title>Gästhamn</Title><ogc:Filter><ogc:PropertyIsEqualTo><ogc:PropertyName>KKOD</ogc:PropertyName> <ogc:Literal><![CDATA[362]]></ogc:Literal> </ogc:PropertyIsEqualTo></ogc:Filter><MaxScaleDenominator>100050</MaxScaleDenominator><PointSymbolizer><Graphic><Mark><WellKnownName>ttf://Wingdings#0x61</WellKnownName><Fill><CssParameter
                    name="fill">#0081FE</CssParameter></Fill></Mark><Opacity>1</Opacity><Size>14</Size><Rotation><ogc:PropertyName>SRIKT</ogc:PropertyName></Rotation></Graphic></PointSymbolizer></Rule>
        <Rule>
          <Name>Fyr</Name>
